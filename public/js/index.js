...
const MARINE_URLS = {
  ios: `https://apps.apple.com/app/6560109315?ref=${encodeURIComponent(
    referralCode
  )}`,
  android: `https://play.google.com/store/apps/details?id=com.lascade.marinetracker&referral=${encodeURIComponent(
    referralCode
  )}`,
};
